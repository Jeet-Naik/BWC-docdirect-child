...
<!-- <form class="form" action="<?php //echo site_url('/dir-search/'); ?>" method="get" id="searchfiltr">
  <div class="form-group">
    <label for="byname">Keyword*</label>
    ...
    <div class="tss_testimonial_slider dots_<?php echo $dots; ?>">
        <div class="owl-carousel <?php echo $uid; ?>">
            <?php echo testiSliderShort_content_helper($content, true, true); 
                query_posts(array('post_type' => 'testimonials','orderby' => 'rand')); if(have_posts()) : while(have_posts()) : the_post(); ?>
                <div class="tss_item"><div class="tss_item_in"><p class="testimonial-content"><?php the_content(); ?></p><span class="author_name"><?php the_title(); ?></span></div>
                </div>
